...
const productSeeds: MockProductSeed[] = [
  ...
  // Sets
  {
    ...
    categorySlug: "sets",
    images: [
      "https://plus.unsplash.com/premium_photo-1681276170281-cf50a487a1b7?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8amV3ZWxsZXJ5JTIwc2V0c3xlbnwwfHwwfHx8MA%3D%3D",
    ],
    stoneType: "Kundan",
    color: "Yellow",
    isFeatured: true,
  ...
  },
  {
    ...
    slug: "diamond-necklace-earring-set",
    price: "15200",
    categorySlug: "sets",
    images: [
  ...
  },
  {
    ...
    categorySlug: "sets",
    images: [
      "https://images.unsplash.com/photo-1738754719555-05aca36707b1?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8ODN8fGpld2VsbGVyeSUyMHNldHN8ZW58MHx8MHx8fDA%3D", ],
    stoneType: "Pearl",
    color: "White",
    isFeatured: false,
    soldCount: 8,
