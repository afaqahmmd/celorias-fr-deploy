...
export default function Hero({ badge, title, subtitle, images }: HeroProps) {
  ...
  return (
    <section className="relative flex min-h-28rem items-center justify-center overflow-hidden md:min-h-36rem xl:min-h-39rem">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-6 py-24 text-center md:py-28">
        ...
        <h1 className="font-serif text-[40px] font-normal leading-[1.2] whitespace-pre-line text-white md:text-[52px] lg:text-[56px]">
          {title}
        </h1>
